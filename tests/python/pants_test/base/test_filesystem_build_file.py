...
class FilesystemBuildFileTest(BuildFileTestBase):
  ...
  def setUp(self):
    ...
    self.buildfile = self.create_buildfile('grandparent/parent/PANTS.BUILD')
  ...
  def test_build_files_family_lookup_1(self):
    ...
    self.assertEquals({self.create_buildfile('grandparent/parent/child2/child3/PANTS.BUILD')},
  ...
  def test_build_files_family_lookup_2(self):
    ...
    buildfile = self.create_buildfile('grandparent/parent/child2/child3/PANTS.BUILD')
  ...
  def test_build_files_scan_with_relpath_ignore(self):
    ...
    self.assertEquals(OrderedSet([
        self.create_buildfile('PANTS.BUILD'),
        self.create_buildfile('PANTS.BUILD.twitter'),
        self.create_buildfile('grandparent/parent/PANTS.BUILD'),
        self.create_buildfile('grandparent/parent/PANTS.BUILD.twitter'),
        self.create_buildfile('grandparent/parent/child5/PANTS.BUILD'),
        self.create_buildfile('issue_1742/PANTS.BUILD.sibling'),
    ]), buildfiles)
  ...
  def test_build_files_scan_with_ignore_patterns(self):
    self.assertEquals(OrderedSet([
      ...
      self.create_buildfile('grandparent/parent/child5/PANTS.BUILD'),
      self.create_buildfile('issue_1742/PANTS.BUILD.sibling'),
    ]), self.scan_buildfiles('', build_ignore_patterns=['PANTS.BUILD.twitter']))

  def test_subdir_ignore(self):
    self.touch('grandparent/child1/PANTS.BUILD')

    self.assertEquals(OrderedSet([
      self.create_buildfile('PANTS.BUILD'),
      self.create_buildfile('PANTS.BUILD.twitter'),
      self.create_buildfile('grandparent/child1/PANTS.BUILD'),
      self.create_buildfile('grandparent/parent/PANTS.BUILD'),
      self.create_buildfile('grandparent/parent/PANTS.BUILD.twitter'),
      self.create_buildfile('grandparent/parent/child2/child3/PANTS.BUILD'),
      self.create_buildfile('grandparent/parent/child5/PANTS.BUILD'),
  ...
  def test_subdir_file_pattern_ignore(self):
    self.assertEquals(OrderedSet([
      ...
      self.create_buildfile('grandparent/parent/child2/child3/PANTS.BUILD'),
      self.create_buildfile('grandparent/parent/child5/PANTS.BUILD'),
    ]), self.scan_buildfiles('', build_ignore_patterns=['PANTS.BUILD.*']))
  ...
  def test_must_exist_true(self):
    with self.assertRaises(BuildFile.MissingBuildFileError):
      self.create_buildfile("path-that-does-not-exist/PANTS.BUILD")
    with self.assertRaises(BuildFile.MissingBuildFileError):
      self.create_buildfile("path-that-does-exist/PANTS.BUILD")
    with self.assertRaises(BuildFile.MissingBuildFileError):
      self.create_buildfile("path-that-does-exist/PANTS.BUILD.invalid.suffix")

  def test_suffix_only(self):
    self.makedirs('suffix-test')
    self.touch('suffix-test/PANTS.BUILD.suffix')
    self.touch('suffix-test/PANTS.BUILD.suffix2')
    self.makedirs('suffix-test/child')
    self.touch('suffix-test/child/PANTS.BUILD.suffix3')
    buildfile = self.create_buildfile('suffix-test/PANTS.BUILD.suffix')
    self.assertEquals(OrderedSet([buildfile, self.create_buildfile('suffix-test/PANTS.BUILD.suffix2')]),
        OrderedSet(self.get_build_files_family('suffix-test')))
    self.assertEquals(OrderedSet([self.create_buildfile('suffix-test/PANTS.BUILD.suffix'),
        self.create_buildfile('suffix-test/PANTS.BUILD.suffix2')]),
        self.get_build_files_family('suffix-test'))
    self.assertEquals(OrderedSet([self.create_buildfile('suffix-test/child/PANTS.BUILD.suffix3')]),
        self.scan_buildfiles('suffix-test/child'))

  def test_directory_called_build_skipped(self):
    # Ensure the buildfiles found do not include grandparent/PANTS.BUILD since it is a dir.
  ...
  def test_dir_is_primary(self):
    self.assertEqual([self.create_buildfile('issue_1742/PANTS.BUILD.sibling')],
  ...
  def test_invalid_root_dir_error(self):
    ...
    with self.assertRaises(ProjectTree.InvalidBuildRootError):
      BuildFile(FileSystemProjectTree('tmp'), 'grandparent/PANTS.BUILD')
  ...
  def test_code(self):
    with safe_open(self.fullpath('PANTS.BUILD.code'), 'w') as fp:
      fp.write('lib = java_library(name="jake", age=42)')
    build_file = self.create_buildfile('PANTS.BUILD.code')
  ...
  def test_code_syntax_error(self):
    with safe_open(self.fullpath('PANTS.BUILD.badsyntax'), 'w') as fp:
      fp.write('java_library(name=if)')
    build_file = self.create_buildfile('PANTS.BUILD.badsyntax')
